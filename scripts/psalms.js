...
define(["cornerstone", "jquery", "lodash", "knockout", "psalms.data"], function(cs, $, _, ko, psalmData) {
    "use strict";
    ...
    function showPage(page, callback) {
        ...
        // Show the page
        _selectElement(page).fadeIn(showPage.speed, function() {
            _transitioning = false;
    ...
    function _selectElement(idElementOrjQuery) {
        ...
        // String
        if (cs.text.isString(idElementOrjQuery)) {
    ...
    var ViewModel = function() {
        ...
        this.psalmNumbers = ko.observableArray(_.map(_.range(1,151), function(i) {
            var partsCount = psalmData.psalmVersions(i);
        ...
        this.selectPsalm = function() {
            ...
            if (number === 119) {
                showPage("psalm119-part-selector");
                return;
            }
            ...
            showPage("psalm-content-page", function() {
                vm.bindPsalmData();
        ...
        this.bindPsalmData = function() {
            ...
            var text =  psalmData.getPsalmText(
                vm.psalmNumber(),
                vm.psalmVersion(),
                true /* format */
            );

            var versions = psalmData.psalmVersions(vm.psalmNumber());
        ...
        this.search = function() {
            ...
            if (term && term.length > 0) {
                this.searchResults(psalmData.search(term));
                showPage("psalm-search-results");
            }
        };
        ...
        this.showPartNumber= function(data) {
            return psalmData.psalmVersions(data.number) > 1;
        };
    };
